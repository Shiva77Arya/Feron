...
def run_uit():
    ...
    Speak(f"Downloading Speed Is {correct_down} M B P S .")
    Speak(f"Uploading Speed Is {correct_Up} M B P S  .")
...
class StartExecution(QMainWindow):
    ...
    def __init__(self):
        ...
        self.ui.label = QMovie("D:\\Desktop\\NAOMI\\Database\\Gui Material\\speedTest.gif")

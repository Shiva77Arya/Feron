...
import datetime
extracted_time=open ('D:\\Desktop\\NAOMI\\Data.txt','rt')
time=extracted_time.read()
Time=str(time)

delete_time=open('D:\\Desktop\\NAOMI\\Data.txt','r+')
...
def  RingerNow(time):
    ...
    time_now =time_to_set.replace("naomi","")
    ...
    while True:
        ...
        if current_time==Alarm_Time:
            ...
            playsound("D:\\Desktop\\NAOMI\\Database\\sounds\\alarmring.mp3")
